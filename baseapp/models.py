...
class Room(models.Model):
    ...
    def __str__(self):   # means in general or until specified room will return it's name
        return self.name
...
class Message(models.Model):
    ...
    def __str__(self):         # means in general Message will return it's body of 0:50 char
